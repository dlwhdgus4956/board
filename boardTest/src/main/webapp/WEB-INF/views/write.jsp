...
<!-- 										<div class="divId"> -->
<!-- 											<strong>No : </strong> <input style="width: 50px;" name="id"> -->
<!-- 										</div> -->
										<div class="divTitle">
											<strong> 제목 : </strong> <input style="width: 400px;" name ="title">
										</div>
									</div>
									<div class="divNameDate">
										<div class="divName">
											<strong> 작성자 : </strong> <input style="width: 60px;" name="name">
										</div>
										<div class="divDate">
											<strong> 작성일 : </strong> <input style="width: 60px;" name="regDate">
										</div>
									</div>
								</div>
								<div class="divBody">
									<textarea style="width:799px; height: 500px;" name="content"></textarea>
								</div>
								<div class="divFooter">
